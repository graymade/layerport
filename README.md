...
- **Batch export.** Select multiple frames or a whole Section. Batches download as a single ZIP instead of a queue of save dialogs. An optional rename map exports frames tagged `[#ID]` under canonical filenames.
- **Optional JPG proofs** at 1x to 4x alongside each PSD, and an optional 2x canvas export.
...
[MIT](LICENSE). Made by [Prisma](https://madebyprisma.com).
